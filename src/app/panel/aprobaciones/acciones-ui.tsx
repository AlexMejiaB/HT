  ...
  return (
    <div className="mt-4">
      <div className="flex flex-wrap items-center gap-3">
        <form action={aprobarFn}>
          ...
          <button
            ...
            className="bg-marca px-5 py-2.5 text-[0.65rem] uppercase tracking-[0.2em] text-papel hover:bg-marca-claro disabled:opacity-60"
          >
      ...
      {mensaje && (
        <p
          role="status"
          className={`mt-3 text-sm ${esError ? "text-marca-claro" : "text-apagado"}`}
        >
          {mensaje}
        </p>
      )}
