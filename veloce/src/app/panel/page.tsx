...
export default async function Resumen({ searchParams }: PageProps<"/panel">) {
  ...
  return (
    <>
      {sinpermiso && (
        <p className="mb-6 border-l-2 border-marca bg-marca-suave px-4 py-3 text-sm text-marca-oscuro">
      ...
      {uso.agotado && (
        <p className="mt-4 border-l-2 border-marca bg-marca-suave px-4 py-3 text-sm text-marca-oscuro">
              ...
              <li key={e.id} className="border-l-2 border-marca bg-papel p-5">
                ...
                <div className="mt-3 flex items-center gap-4">
                  <form action={marcarEscalamientoAtendido}>
                    ...
                    <button
                      type="submit"
                      className="bg-tinta px-4 py-2 text-xs font-bold uppercase tracking-wide text-papel hover:bg-marca"
                    >
