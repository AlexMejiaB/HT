/**
 * Contenido comercial de la marca. Fuente única de verdad para la landing:
 * los precios y textos vienen del documento comercial y del brief de producto.
 * Cambiar la oferta aquí se refleja en toda la página.
 */
...
export const site = {
  ...
  descripcion:
    "Veloce AI atiende las conversaciones repetitivas de tu tienda, consulta información real y entrega los casos importantes a tu equipo.",

  hero: {
    etiqueta: "Paquetes comerciales",
    titulo: ["Agentes de IA", "para e-commerce."],
  ...
  mensaje: {
    ...
    cuerpo:
      "Veloce AI atiende conversaciones repetitivas, consulta información real y entrega los casos importantes a tu equipo. Empieza pequeño; agrega automatizaciones sólo cuando estén probadas.",
  },

  /** Perfil del cliente objetivo, del brief de producto. */
  clienteIdeal:
  ...
  promesa:
    "Si tu tienda ya vende, pero tú sigues respondiendo cada mensaje de WhatsApp, Veloce AI responde la operación repetitiva para que tú te enfoques en vender y surtir.",
} as const;
...
/** Lo que compran los tres paquetes, del documento comercial. */
...
/** Guardrails del brief: es el argumento de confianza más fuerte de la oferta. */
...
/** Fases de construcción del brief, usadas como "cómo funciona". */
export const fases = [
  {
    fase: "Fase 1",
    nombre: "Veloce Responde",
...
/** El primer flujo que debe quedar perfecto, del brief. Sirve de demo en la landing. */
...
/**
 * Contacto. Se lee de variables de entorno públicas para no quemar
 * teléfonos ni URLs en el repositorio.
 */
export const contacto = {
  whatsapp: process.env.NEXT_PUBLIC_WHATSAPP_NUMERO ?? "5215500000000",
  mensajeWhatsapp:
    "Hola, vengo de la página de Veloce AI y quiero saber más sobre los paquetes.",
