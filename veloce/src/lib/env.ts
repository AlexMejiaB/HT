...
const esquema = z.object({
  ...
  // Los modelos que razonan gastan el presupuesto de tokens pensando y truncan
  // la respuesta. Clasificar y redactar dos frases no lo necesita.
  // Valores: none | low | medium | high | omitir (no manda el parámetro).
  LLM_RAZONAMIENTO: z.string().default("none"),
